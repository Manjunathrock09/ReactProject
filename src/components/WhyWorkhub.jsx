      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "0 20px" }}>
        <Row gutter={[48, 48]} align="top">
          ...
          <Col xs={24} md={10}>
            ...
            <Title level={2} style={{ fontWeight: "bold", lineHeight: "1.2" }}>
              We empower our clients businesses.
            </Title>
            <Text type="secondary">
            ...
            <br /><br />
            <Link
              to="/our-company"  // New route for "Our Company"
              style={{ fontWeight: "bold", color: "#333", textDecoration: "none", fontSize: "16px" }}
            >
            ...
            <Row gutter={[24, 24]}>
              {featuresData.map((feature) => (
                <Col key={feature.id} xs={24} sm={12}>
                  <Card
                    hoverable
                    bordered={false} // Remove border warning; if needed, use variant="default" or "outlined"
                    style={{
                      textAlign: "center",
                      padding: "20px",
                  ...
                  >
                    <div style={{ fontSize: "50px", color: "#D9534F", marginBottom: "10px" }}>
                      {feature.icon}
                    </div>
                    <Title level={5} className="fw-bold">{feature.title}</Title>
